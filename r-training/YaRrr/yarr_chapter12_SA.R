...
> display.brewer.all()
Error in display.brewer.all() : 
  could not find function "display.brewer.all"
...
+       side = 1, at = 1:4, las = 1,
+       line = 1, col = gray(.95))
Error in mtext(text = parrot.data$ship, side = 1, at = 1:4, las = 1, line = 1,  : 
...
Error in rect(xleft = 1:4 - 0.35 - 0.04/2, ybottom = rep(0, 4), xright = 1:4 -  : 
  plot.new has not been called yet
> 
> # Green bars
> rect(xleft = 1:4 + .04 / 2,
...
Error in rect(xleft = 1:4 + 0.04/2, ybottom = rep(0, 4), xright = 1:4 +  : 
  plot.new has not been called yet
> 
...
Error in mtext("Number of Green and Blue parrots on 4 ships", side = 3,  : 
  plot.new has not been called yet
> mtext("Parrots", side = 2, col = "white", line = 3.5)
Error in mtext("Parrots", side = 2, col = "white", line = 3.5) : 
  plot.new has not been called yet
> mtext("Source: Drunken survey on 22 May 2015", side = 1,
+       at = 0, adj = 0, line = 3, font = 3, col = "white")
Error in mtext("Source: Drunken survey on 22 May 2015", side = 1, at = 0,  : 
  plot.new has not been called yet
> 